...
* compute_class_weights - inverse-frequency weights for
...
* apply_smote - SMOTE oversampling of the minority classes.
* augment_rare_classes - stronger oversampling (BorderlineSMOTE,
...
def augment_rare_classes(x, y, method: str = "borderline", seed: int = DEFAULT_SEED):
    ...
    * "smoteenn" - SMOTE followed by Edited-Nearest-Neighbours
    ...
    was not oversampled by BorderlineSMOTE. Plain apply_smote, or
